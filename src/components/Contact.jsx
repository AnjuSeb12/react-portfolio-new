...
//           </div>
//           <div className="mb-4">
//             <label htmlFor="message" className="block text-teal-900">Message</label>
//             <textarea 
//               name="message" 
...
//               required 
//               rows="4" 
//               className="border border-gray-300 rounded-md p-2 w-full bg-gray-700  text-teal-500"
//             />
//           </div>
//           <button 
//             type="submit" 
//             className="bg-gray-700 text-white py-2 px-4 rounded-md hover:bg-teal-700 w-full"
//           >
//             Send Message
//           </button>
//         </form>
